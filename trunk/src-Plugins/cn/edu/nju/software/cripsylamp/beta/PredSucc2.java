...
class PredSucc2 {
    ...
    public boolean equals(PredSucc2 ps) {
        return this.predecessor.size() == ps.predecessor.size() && this.predecessor.containsAll(ps.predecessor) && this.successor.size() == ps.successor.size() && this.successor.containsAll(ps.successor);
    }
